...
HD_PWD='/home/subi/codes/FPGA_projects/AXI-DMA/AXI-DMA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_DMA_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_DMA_wrapper.tcl -notrace
