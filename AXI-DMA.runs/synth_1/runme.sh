...
HD_PWD='/home/subi/codes/FPGA_projects/AXI-DMA/AXI-DMA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_DMA_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_DMA_wrapper.tcl
